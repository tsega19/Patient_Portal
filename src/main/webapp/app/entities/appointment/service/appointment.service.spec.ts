...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../appointment.test-samples';

import { AppointmentService } from './appointment.service';

const requireRestSample: IAppointment = {
